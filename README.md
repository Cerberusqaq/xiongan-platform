...
| 文档 | 内容 | 对应交付 |
| --- | --- | --- |
| 系统设计与算法报告.md | 总体方案、算法原理（三方案+LLM 见正文与附录C/D）、实验、创新点 | 提交① |
| 实验评估报告.md | 对比实验与图表 | 提交③ |
| 接口文档.md | REST/WS 全端点、错误码、OpenAPI 导入、云-边-端数据流 | 功能一任务1 |
| 部署运行说明.md | Windows/Docker 运行、自检、FAQ | 提交②配套 |
| 全技术栈说明.md | 面向零基础的全栈讲解 | 培训 |
| MAPPO训练与验证指南.md | 模型训练与复现 | 团队 |
| 前端设计规范.md | 前端规范与设计建议（方向B） | 团队 |
| 路网规格与接入指南.md | 真实路网接入规范（组员用） | 协作 |
