...
- `docs/全技术栈说明.md` —— 面向零基础的全栈技术讲解（推荐先读）
- `docs/平台README.md`、`docs/接口文档.md` —— 后端接口
- `docs/MAPPO训练与验证指南.md` —— 模型训练
- `docs/三套方案工作原理.md`、`docs/系统设计与算法报告.md` —— 算法设计
- `docs/LLM智能体Agent介绍.md`、`docs/云边端架构.md` —— 架构设计
